-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'IN_PREPARATION', 'DELIVERED', 'FINISHED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "ConsumptionMethod" AS ENUM ('DINE_IN', 'DELIVERY', 'PICKUP');
